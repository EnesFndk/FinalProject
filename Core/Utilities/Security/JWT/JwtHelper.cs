...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        //TokenOptions = Configuration ile api'deki appsettings.json'daki değerleri okuduk ya o nesneleri bir değere atamamıza yarıyor.
        ...
        //Nuget'den system.identityModel.Tokens.jwt ' yi yüklüyoruz ve çözüyoruz.
